...
func _abstract_on_deactivate():
	...
	print("Deactivate here")


## @override
func _abstract_on_expire():
	print("Naturally expires here")
	pass
...
func get_effect_description():
	return "<Burn2> Lose %d health at the end of your phase for %d turn(s)" % [BURN_DAMAGE, BURN_DURATION]
